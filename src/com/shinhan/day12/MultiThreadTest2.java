...
public class MultiThreadTest2 {
	...
	public static void main3(String[] args) {
		...
		thread1.setName("kim쓰레드");
		thread2.setName("park쓰레드");
		thread3.setName("yang쓰레드");
		thread4.setName("yun쓰레드");
		thread1.start();
		thread2.start();
		thread3.start();
		thread4.start();
	...
	public static void main2(String[] args) {
		...
		Thread thread1 = new TransferThread("이체쓰레드", shareArea);
		Thread thread2 = new PrintThread("출력쓰레드", shareArea);
		thread1.start();
		thread2.start();
